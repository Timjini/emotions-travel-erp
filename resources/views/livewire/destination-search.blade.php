<div class="relative">
    ...
    <div class="relative mt-1">
        ...
        <input 
            ...
            class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-xl leading-5 
                   bg-gray-50 placeholder-gray-500 focus:outline-none focus:ring-blue-500 
    ...
    @if($showDropdown && !empty($search))
        <div class="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-md py-1 text-base 
                    ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm max-h-60">
                    ...
                    @foreach($destinations as $index => $destination)
                        <li 
                            ...
                            class="text-gray-900 cursor-default select-none relative py-2 pl-3 pr-9 
                                   hover:bg-blue-50 {{ $highlightIndex === $index ? 'bg-blue-50' : '' }}"
                        >
            ...
            @else
                <div class="text-gray-500 py-2 pl-3 pr-9">No destinations found</div>
            @endif
        </div>
    @endif
</div>
